...
var Nodes = []Node{
	...
	},
	{
		...
		Inputs:    []string{"pipeline/gate_coverage.go", "pipeline/gate_coverage_budget.go", "pipeline/gates_test.go", "gates/ledger.json", "src/registry/tiers.json", "generated/ir/**", "docs/example-oracle.json", "docs/demos/**", "tools/contracts/components/**"},
	...
	},
	{
		...
		Inputs:    []string{"pipeline/overlay.go", "pipeline/default_content.go", "pipeline/docs_transforms.go", "pipeline/emitter_css.go", "pipeline/resolve_skins.go", "pipeline/jssource.go", "pipeline/browser_shell.go", "pipeline/build_rtl.go", "pipeline/main.go", "tools/browser-shell.mjs", "tools/contracts/components/**", "src/emitter/skin.mjs", "src/registry/rtl-translations.json", "generated/ir/**", "src/registry/pin.json", "src/runtime/components/**", "src/runtime/core.js", "overlays/**", "docs/example-oracle.json", "docs/example-fixture-targets.json", "docs/demos/**", upstreamExamplesGlob, upstreamDocsGlob},
		Produces:  nil,
	...
	},
	{
		...
		Run:       [][]string{{"./build/pipeline", "resolve-skins"}, {"./build/pipeline", "convert"}},
		Inputs:    []string{"pipeline/convert.go", "pipeline/resolve_skins.go", "pipeline/internal/twmerge/**", "pipeline/internal/tsx/**", "src/registry/tiers.json", "src/registry/pin.json", "src/kernel/**", ".upstream/shadcn-ui/apps/v4/registry/bases/radix/**", ".upstream/shadcn-ui/apps/v4/registry/styles/style-nova.css"},
		Produces:  []string{"generated/ir", "build/resolved-ui"},
	...
	},
	{
		...
		Inputs:   []string{"pipeline/emit.go", "pipeline/emitter_css.go", "pipeline/emitter_html.go", "pipeline/default_content.go", "pipeline/prepaint.go", "pipeline/tags.go", "pipeline/resolve_skins.go", "src/registry/tiers.json", "generated/ir/**", "probes/h4/globals.css"},
	...
	},
	{
		...
		Inputs:    []string{"pipeline/example_oracle.go", "pipeline/oracle_lib.go", "pipeline/resolve_skins.go", "pipeline/oracle_canon.js", "pipeline/browser_shell.go", "tools/browser-shell.mjs", "pipeline/prepaint.go", "src/registry/tiers.json", "src/runtime/components/**", "docs/catalog.json", "tools/contracts/stubs/**", "src/emitter/skin.mjs", "src/registry/pin.json", "src/registry/upstream-snapshot/exemptions.json", "package-lock.json", upstreamExamplesGlob},
	...
	},
	{
		...
		Inputs: []string{"pipeline/demo.go", "pipeline/emitter_css.go", "pipeline/default_content.go", "pipeline/prepaint.go", "pipeline/tags.go", "pipeline/resolve_skins.go", "src/registry/tiers.json", "generated/ir/**", "src/kernel/**", "probes/h4/globals.css", "probes/t7/**", "probes/t8/**"},
	...
	},
	{
		...
		Inputs:    []string{"pipeline/tw.go", "pipeline/main.go", "dist/globals.css", "dist/components/**", "dist/js/**", "docs/demos/**", "docs/content/**", "src/kernel/**", "tools/contracts/out/**", "generated/ir/**", "probes/t7/**", "probes/t8/**", "package.json"},
	...
	},
	{
		...
		Inputs:    []string{"pipeline/path_parity.go", "pipeline/pp_readall.js", "pipeline/parity_baseline.go", "pipeline/emitter_css.go", "pipeline/tags.go", "pipeline/browser_shell.go", "tools/browser-shell.mjs", "gates/path-parity-baseline.json", "gates/ledger.json", "src/emitter/skin.mjs", "generated/ir/**", "dist/css/**", "dist/shadless.full.css", "build/gates/oracle.css", "src/registry/pin.json"},
		Produces:  nil,
	...
	},
	{
		...
		Inputs:    []string{"pipeline/contract.go", "pipeline/oracle_lib.go", "pipeline/resolve_skins.go", "pipeline/browser_shell.go", "tools/browser-shell.mjs", "tools/contracts/stubs/**", "tools/contracts/components/**", "dist/**", "src/kernel/**", "src/registry/pin.json", "package-lock.json", "gates/ledger.json"},
	...
	},
	{
		...
		Inputs:    []string{"pipeline/demo_smoke.go", "pipeline/browser_shell.go", "tools/browser-shell.mjs", "dist/**", "generated/ir/**", "src/registry/tiers.json"},
		Produces:  nil,
	...
	},
	{
		...
		Produces:  []string{"docs/site/content", "docs/site/static", "docs/content-map.json"},
	...
	},
	{
		...
		Run:   [][]string{{"zola", "--root", "docs/site", "build"}},
		...
		Inputs:   []string{"docs/site/content/**", "docs/site/static/**", "docs/site/config.toml", "docs/site/templates/**", "docs/site/sass/**", "docs/site/themes/**"},
		Produces: []string{"docs/site/public"},
	...
	},
	{
		...
		Inputs:    []string{"pipeline/docs_consistency.go", "pipeline/resolve_skins.go", "docs/site/content/**", "dist/components/**", "dist/css/**", "docs/demos/**", "package.json"},
		Produces:  nil,
	...
	},
	{
		...
		Inputs:    []string{"pipeline/docs_fidelity_driver.go", "pipeline/docs_fidelity.go", "pipeline/docs_transforms.go", "pipeline/docs_overrides.go", "pipeline/docs_guides.go", "pipeline/docs_frontmatter.go", "docs/site/content/**", "docs/site/static/demos/**", "docs/content-map.json", "docs/content/**", "src/registry/pin.json", docsUpstreamMirror + "/**"},
		Produces:  nil,
	...
	},
	{
		...
		Inputs:    []string{"pipeline/docs_smoke.go", "pipeline/browser_shell.go", "tools/browser-shell.mjs", "docs/site/public/**"},
		Produces:  nil,
	...
	},
	{
		...
		Needs:     []NodeID{NDocsBuild, NBuildJs},
		Run:       [][]string{{"./build/pipeline", "interactivity-sweep"}},
		Inputs:    []string{"pipeline/interactivity_sweep.go", "pipeline/browser_shell.go", "tools/browser-shell.mjs", "docs/site/static/demos/**", "src/registry/tiers.json", "gates/ledger.json"},
		Produces:  nil,
	...
	},
	{
		...
		Inputs:    []string{"pipeline/example_golden.go", "pipeline/oracle_lib.go", "pipeline/resolve_skins.go", "pipeline/oracle_canon.js", "pipeline/browser_shell.go", "tools/browser-shell.mjs", "src/registry/upstream-snapshot/**", "gates/ledger.json", "tools/contracts/stubs/**", "src/emitter/skin.mjs", "src/registry/pin.json", "package-lock.json", upstreamExamplesGlob},
		Produces:  nil,
