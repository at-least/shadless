    ...
    DayPicker,
    {
      ...
      classNames: {
        ...
        caption_label: cn(
          ...
          captionLayout === "label" ? "text-sm" : "h-6 pr-1 pl-1.5 flex items-center gap-1 rounded-(--cell-radius) text-sm [&>svg]:size-3.5 [&>svg]:text-muted-foreground",
      ...
      components: {
          ...
          if (orientation === "left") {
            return /* @__PURE__ */ React.createElement(
              IconPlaceholder,
              {
                ...
                className: cn("cn-rtl-flip size-4", className2),
                ...props2
              }
            );
          }
        ...
        DayButton: ({ ...props2 }) => /* @__PURE__ */ React.createElement(CalendarDayButton, { locale, ...props2 }),
