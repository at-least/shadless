...
/* Upstream parity: line-number gutter + dual-theme shiki tokens.
   ...
   carry --shiki-light/--shiki-dark inline vars (set in the browser by
   highlight.js); site chrome switches on :root.dark — same mechanism
   upstream uses for its vesper dark theme. */
...
article pre code[data-line-numbers-max-digits="4"] { --ln-gutter: 3rem; }
