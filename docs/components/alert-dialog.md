...
::: code-group
```text:line-numbers [alert-dialog.html]
<div>
  <button
    type="button"
...
::: code-group
```text:line-numbers [alert-dialog-basic.html]
<button
  data-slot="alert-dialog-trigger"
  data-variant="outline"
  data-size="default"
...
::: code-group
```text:line-numbers [alert-dialog-small.html]
<button
  data-slot="alert-dialog-trigger"
  data-variant="outline"
  data-size="default"
...
::: code-group
```text:line-numbers [alert-dialog-media.html]
<button
  data-slot="alert-dialog-trigger"
  data-variant="outline"
  data-size="default"
...
::: code-group
```text:line-numbers [alert-dialog-small-media.html]
<button
  data-slot="alert-dialog-trigger"
  data-variant="outline"
  data-size="default"
...
::: code-group
```text:line-numbers [alert-dialog-destructive.html]
<button
  data-slot="alert-dialog-trigger"
...
::: code-group
```text:line-numbers [alert-dialog-rtl.html]
