...
::: code-group
```text:line-numbers [context-menu.html]
<div>
  <span
    data-state="closed"
...
**Copy the markup from `dist/components/context-menu.html` into your page and adapt it — the inline utilities are picked up by your build's content scan.**
...
::: code-group
```text:line-numbers [context-menu-basic.html]
<span
  data-state="closed"
  data-slot="context-menu-trigger"
...
::: code-group
```text:line-numbers [context-menu-submenu.html]
<span
  data-state="closed"
  data-slot="context-menu-trigger"
  class="select-none flex aspect-video w-full max-w-xs items-center justify-center rounded-xl border border-dashed text-sm"
...
::: code-group
```text:line-numbers [context-menu-shortcuts.html]
<span
  data-state="closed"
  data-slot="context-menu-trigger"
  class="select-none flex aspect-video w-full max-w-xs items-center justify-center rounded-xl border border-dashed text-sm"
...
::: code-group
```text:line-numbers [context-menu-groups.html]
<span
  data-state="closed"
  data-slot="context-menu-trigger"
  class="select-none flex aspect-video w-full max-w-xs items-center justify-center rounded-xl border border-dashed text-sm"
...
::: code-group
```text:line-numbers [context-menu-icons.html]
<span
  data-state="closed"
  data-slot="context-menu-trigger"
  class="select-none flex aspect-video w-full max-w-xs items-center justify-center rounded-xl border border-dashed text-sm"
...
::: code-group
```text:line-numbers [context-menu-checkboxes.html]
<span
  data-state="closed"
  data-slot="context-menu-trigger"
  class="select-none flex aspect-video w-full max-w-xs items-center justify-center rounded-xl border border-dashed text-sm"
...
::: code-group
```text:line-numbers [context-menu-radio.html]
<span
  data-state="closed"
  data-slot="context-menu-trigger"
  class="select-none flex aspect-video w-full max-w-xs items-center justify-center rounded-xl border border-dashed text-sm"
...
::: code-group
```text:line-numbers [context-menu-destructive.html]
<span
  data-state="closed"
  data-slot="context-menu-trigger"
  class="select-none flex aspect-video w-full max-w-xs items-center justify-center rounded-xl border border-dashed text-sm"
...
::: code-group
```text:line-numbers [context-menu-rtl.html]
<span
  data-state="closed"
  data-slot="context-menu-trigger"
  class="select-none flex aspect-video w-full max-w-xs items-center justify-center rounded-xl border border-dashed text-sm"
