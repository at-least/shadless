...
::: code-group
```text:line-numbers [button-demo.html]
...
::: code-group
```text:line-numbers [button-size.html]
...
::: code-group
```text:line-numbers [button-default.html]
<button
  data-slot="button"
...
::: code-group
```text:line-numbers [button-outline.html]
<button
  data-slot="button"
  data-variant="outline"
  data-size="default"
...
::: code-group
```text:line-numbers [button-secondary.html]
<button
  data-slot="button"
...
::: code-group
```text:line-numbers [button-ghost.html]
<button
  data-slot="button"
  data-variant="ghost"
  data-size="default"
...
::: code-group
```text:line-numbers [button-destructive.html]
<button
  data-slot="button"
...
::: code-group
```text:line-numbers [button-link.html]
<button
  data-slot="button"
  data-variant="link"
  data-size="default"
...
::: code-group
```text:line-numbers [button-icon.html]
<button
  data-slot="button"
  data-variant="outline"
  data-size="icon"
...
::: code-group
```text:line-numbers [button-with-icon.html]
<button
  data-slot="button"
  data-variant="outline"
  data-size="sm"
...
::: code-group
```text:line-numbers [button-rounded.html]
...
::: code-group
```text:line-numbers [button-spinner.html]
...
::: code-group
```text:line-numbers [button-aschild.html]
<a
  href="/login"
  data-slot="button"
  data-variant="default"
...
::: code-group
```text:line-numbers [button-rtl.html]
