...
::: code-group
```text:line-numbers [spinner-demo.html]
...
::: code-group
```text:line-numbers [spinner-custom.html]
...
::: code-group
```text:line-numbers [spinner-size.html]
...
::: code-group
```text:line-numbers [spinner-button.html]
...
::: code-group
```text:line-numbers [spinner-badge.html]
...
::: code-group
```text:line-numbers [spinner-input-group.html]
...
::: code-group
```text:line-numbers [spinner-empty.html]
<div
  data-slot="empty"
...
::: code-group
```text:line-numbers [spinner-rtl.html]
