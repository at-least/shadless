...
<div class="demo-missing" data-demo="ai-sdk-helper-demo" data-status="unavailable">demo not available in shadless (base-style demo) — <code>ai-sdk-helper-demo</code></div>
