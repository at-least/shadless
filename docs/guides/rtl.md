...
<div class="mt-6 grid gap-4 sm:grid-cols-2 sm:gap-6">
  <div class="linked-card">
    ...
    <p class="mt-2 font-medium">Next.js</p>
  </div>
  <div class="linked-card">
    <svg
      role="img"
  ...
  <div class="linked-card">
    ...
    <p class="mt-2 font-medium">TanStack Start</p>
  </div>
</div>
...
For other styles, the shipped utilities are already logical (start/end-aware) — `dir="rtl"` is all it takes.
