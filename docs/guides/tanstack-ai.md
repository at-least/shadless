...
<div class="demo-missing" data-demo="tanstack-ai-helper-demo" data-status="unavailable">demo not available in shadless (base-style demo) — <code>tanstack-ai-helper-demo</code></div>
...
Use the [AI SDK helper](/guides/ai-sdk) when a preview needs the AI SDK's
