...
{% <demo name="collapsible-demo" status="authored"> %}
...
{% <codegroup> %}
```text,name=collapsible-demo.html
...
{% <demo name="collapsible-basic" status="authored"> %}
...
{% <codegroup> %}
```text,name=collapsible-basic.html
<div
  data-slot="card"
  data-size="default"
...
{% <demo name="collapsible-settings" status="authored"> %}
...
{% <codegroup> %}
```text,name=collapsible-settings.html
<div
  data-slot="card"
  data-size="sm"
...
{% <demo name="collapsible-file-tree" status="authored"> %}
...
{% <codegroup> %}
```text,name=collapsible-file-tree.html
<div
  data-slot="card"
  data-size="sm"
...
{% <demo name="collapsible-rtl" status="authored"> %}
...
{% <codegroup> %}
```text,name=collapsible-rtl.html
