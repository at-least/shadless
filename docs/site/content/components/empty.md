...
{% <demo name="empty-demo" status="authored"> %}
...
{% <demo name="empty-outline" status="authored"> %}
...
{% <demo name="empty-background" status="authored"> %}
...
{% <codegroup> %}
```text,name=empty-background.html
<div
  data-slot="empty"
...
{% <demo name="empty-avatar" status="authored"> %}
...
{% <demo name="empty-avatar-group" status="authored"> %}
...
{% <codegroup> %}
```text,name=empty-avatar-group.html
<div
  data-slot="empty"
  class="gap-4 rounded-xl border-dashed p-6 flex w-full min-w-0 flex-1 flex-col items-center justify-center text-center text-balance"
>
...
{% <demo name="empty-input-group" status="authored"> %}
...
{% <codegroup> %}
```text,name=empty-input-group.html
<div
  data-slot="empty"
  class="gap-4 rounded-xl border-dashed p-6 flex w-full min-w-0 flex-1 flex-col items-center justify-center text-center text-balance"
>
...
{% <demo name="empty-rtl" status="authored"> %}
