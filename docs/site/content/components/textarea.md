...
{% <demo name="textarea-demo" status="authored"> %}
...
{% <demo name="textarea-field" status="authored"> %}
...
{% <demo name="textarea-disabled" status="authored"> %}
...
{% <codegroup> %}
```text,name=textarea-disabled.html
<div
  role="group"
  data-slot="field"
  data-orientation="vertical"
...
{% <demo name="textarea-invalid" status="authored"> %}
...
{% <codegroup> %}
```text,name=textarea-invalid.html
<div
  role="group"
  data-slot="field"
  data-orientation="vertical"
...
{% <demo name="textarea-button" status="authored"> %}
...
{% <codegroup> %}
```text,name=textarea-button.html
...
{% <demo name="textarea-rtl" status="authored"> %}
