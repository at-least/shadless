...
{% <demo name="attachment-demo" status="authored"> %}
...
{% <codegroup> %}
```text,name=attachment-demo.html
...
{% <demo name="attachment-image" status="authored"> %}
...
{% <codegroup> %}
```text,name=attachment-image.html
...
{% <demo name="attachment-states" status="authored"> %}
...
{% <codegroup> %}
```text,name=attachment-states.html
...
{% <demo name="attachment-sizes" status="authored"> %}
...
{% <codegroup> %}
```text,name=attachment-sizes.html
<div class="mx-auto flex w-full max-w-sm flex-col gap-3 py-12">
  <div
    data-slot="attachment"
    data-state="done"
...
{% <demo name="attachment-group" status="authored"> %}
...
{% <codegroup> %}
```text,name=attachment-group.html
<div class="mx-auto w-full max-w-sm py-12">
  <div
    data-slot="attachment-group"
    class="gap-3 scroll-px-1 py-1 flex min-w-0 scroll-fade-x snap-x snap-mandatory scrollbar-none overflow-x-auto overscroll-x-contain *:data-[slot=attachment]:flex-none *:data-[slot=attachment]:snap-start w-full"
...
{% <demo name="attachment-trigger" status="authored"> %}
...
{% <codegroup> %}
```text,name=attachment-trigger.html
<div class="mx-auto w-full max-w-sm py-12">
  <div
    data-slot="attachment"
    data-state="done"
