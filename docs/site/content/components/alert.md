...
{% <demo name="alert-demo" status="existing-dist"> %}
...
{% <demo name="alert-basic" status="authored"> %}
...
{% <demo name="alert-destructive" status="authored"> %}
...
{% <codegroup> %}
```text,name=alert-destructive.html
<div
  data-slot="alert"
  role="alert"
...
{% <demo name="alert-action" status="authored"> %}
...
{% <demo name="alert-colors" status="authored"> %}
...
{% <demo name="alert-rtl" status="authored"> %}
