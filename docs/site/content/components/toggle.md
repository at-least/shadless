...
{% <demo name="toggle-demo" status="authored"> %}
...
{% <demo name="toggle-outline" status="authored"> %}
...
{% <demo name="toggle-text" status="authored"> %}
...
{% <demo name="toggle-sizes" status="authored"> %}
...
{% <demo name="toggle-disabled" status="authored"> %}
...
{% <codegroup> %}
```text,name=toggle-disabled.html
<div class="flex flex-wrap items-center gap-2">
  <button
    type="button"
    aria-pressed="false"
...
{% <demo name="toggle-rtl" status="authored"> %}
