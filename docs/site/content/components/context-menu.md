...
{% <demo name="context-menu-demo" status="existing-dist"> %}
...
<div>
  <span
    ...
    class="select-none"
    id="d1-trigger"
    data-radixuigo-context-trigger="d1"
    >Right click here</span
  >
</div>
<template id="d1-tpl">
  <div
...
{% <demo name="context-menu-basic" status="authored"> %}
...
{% <codegroup> %}
```text,name=context-menu-basic.html
<span
  data-state="closed"
  data-slot="context-menu-trigger"
  class="select-none flex aspect-video w-full max-w-xs items-center justify-center rounded-xl border border-dashed text-sm"
  id="m0-trigger"
  data-radixuigo-context-trigger="m0"
  ><span class="hidden pointer-fine:inline-block">Right click here</span
  ><span class="hidden pointer-coarse:inline-block">Long press here</span></span
>
<template id="m0-tpl">
  <div
    data-side="right"
    ...
    "
  >
    <div role="group" data-slot="context-menu-group">
      <div
        role="menuitem"
        data-slot="context-menu-item"
        data-variant="default"
...
{% <demo name="context-menu-submenu" status="authored"> %}
...
{% <codegroup> %}
```text,name=context-menu-submenu.html
<span
  data-state="closed"
  data-slot="context-menu-trigger"
  class="select-none flex aspect-video w-full max-w-xs items-center justify-center rounded-xl border border-dashed text-sm"
...
<template id="m0-tpl">
  ...
  >
    <div role="group" data-slot="context-menu-group">
      ...
      >
        Copy<span
          ...
          class="text-muted-foreground group-focus/context-menu-item:text-accent-foreground ml-auto text-xs tracking-widest"
          >⌘C</span
        >
      </div>
      <div
    ...
    <div
      ...
      class="focus:bg-accent focus:text-accent-foreground data-open:bg-accent data-open:text-accent-foreground gap-1.5 rounded-md px-1.5 py-1 text-sm data-inset:pl-7 [&amp;_svg:not([class*='size-'])]:size-4 flex cursor-default items-center outline-hidden select-none [&amp;_svg]:pointer-events-none [&amp;_svg]:shrink-0"
      tabindex="-1"
      data-orientation="vertical"
      data-radix-collection-item=""
...
{% <demo name="context-menu-shortcuts" status="authored"> %}
...
{% <codegroup> %}
```text,name=context-menu-shortcuts.html
<span
  data-state="closed"
  data-slot="context-menu-trigger"
  class="select-none flex aspect-video w-full max-w-xs items-center justify-center rounded-xl border border-dashed text-sm"
...
{% <demo name="context-menu-groups" status="authored"> %}
...
{% <codegroup> %}
```text,name=context-menu-groups.html
<span
  data-state="closed"
  data-slot="context-menu-trigger"
  class="select-none flex aspect-video w-full max-w-xs items-center justify-center rounded-xl border border-dashed text-sm"
...
{% <demo name="context-menu-icons" status="authored"> %}
...
{% <codegroup> %}
```text,name=context-menu-icons.html
<span
  data-state="closed"
  data-slot="context-menu-trigger"
  class="select-none flex aspect-video w-full max-w-xs items-center justify-center rounded-xl border border-dashed text-sm"
    ...
    <div role="group" data-slot="context-menu-group">
      ...
      >
        ...
        >
          ...
          ></path>
          <path d="m17 10 4 4-4 4"></path></svg
        >Paste
      </div>
    </div>
    <div
...
{% <demo name="context-menu-checkboxes" status="authored"> %}
...
{% <codegroup> %}
```text,name=context-menu-checkboxes.html
<span
  data-state="closed"
  data-slot="context-menu-trigger"
  class="select-none flex aspect-video w-full max-w-xs items-center justify-center rounded-xl border border-dashed text-sm"
  ...
  >
    <div role="group" data-slot="context-menu-group">
      <div
        ...
        data-radix-collection-item=""
      >
        <span class="absolute right-2 pointer-events-none"></span>Show Bookmarks Bar
      </div>
      <div
        role="menuitemcheckbox"
        aria-checked="false"
        ...
        data-radix-collection-item=""
      >
        <span class="absolute right-2 pointer-events-none"></span>Show Full URLs
      </div>
      <div
        role="menuitemcheckbox"
        aria-checked="false"
        ...
        data-radix-collection-item=""
      >
        <span class="absolute right-2 pointer-events-none"></span>Show Developer Tools
      </div>
    </div>
  </div>
</template>
...
{% <demo name="context-menu-radio" status="authored"> %}
...
{% <codegroup> %}
```text,name=context-menu-radio.html
<span
  data-state="closed"
  data-slot="context-menu-trigger"
  class="select-none flex aspect-video w-full max-w-xs items-center justify-center rounded-xl border border-dashed text-sm"
    ...
    <div role="group" data-slot="context-menu-group">
      ...
      <div role="group" data-slot="context-menu-radio-group">
        ...
        <div
          ...
          data-radix-collection-item=""
        >
          <span class="absolute right-2 pointer-events-none"></span>Colm Tuite
        </div>
      </div>
    </div>
    <div
    ...
    <div role="group" data-slot="context-menu-group">
      ...
      <div role="group" data-slot="context-menu-radio-group">
        ...
        <div
          ...
          data-radix-collection-item=""
        >
          <span class="absolute right-2 pointer-events-none"></span>Dark
        </div>
        <div
          role="menuitemradio"
          aria-checked="false"
          ...
          data-radix-collection-item=""
        >
          <span class="absolute right-2 pointer-events-none"></span>System
        </div>
      </div>
    </div>
  </div>
...
{% <demo name="context-menu-destructive" status="authored"> %}
...
{% <codegroup> %}
```text,name=context-menu-destructive.html
<span
  data-state="closed"
  data-slot="context-menu-trigger"
  class="select-none flex aspect-video w-full max-w-xs items-center justify-center rounded-xl border border-dashed text-sm"
...
{% <demo name="context-menu-rtl" status="authored"> %}
...
{% <codegroup> %}
```text,name=context-menu-rtl.html
<span
  data-state="closed"
  data-slot="context-menu-trigger"
  class="select-none flex aspect-video w-full max-w-xs items-center justify-center rounded-xl border border-dashed text-sm"
  ...
  ><span class="hidden pointer-coarse:inline-block">اضغط مطولاً هنا</span></span
>
<template id="m0-tpl">
  <div
    data-side="left"
  ...
  >
    <div role="group" data-slot="context-menu-group">
      <div
        ...
        data-state="closed"
        data-slot="context-menu-sub-trigger"
        class="focus:bg-accent focus:text-accent-foreground data-open:bg-accent data-open:text-accent-foreground gap-1.5 rounded-md px-1.5 py-1 text-sm data-inset:ps-7 [&amp;_svg:not([class*='size-'])]:size-4 flex cursor-default items-center outline-hidden select-none [&amp;_svg]:pointer-events-none [&amp;_svg]:shrink-0"
        tabindex="-1"
        data-orientation="vertical"
        data-radix-collection-item=""
        data-radixuigo-menu-subtrigger="m0s0"
    ...
    <div role="group" data-slot="context-menu-group">
      ...
      <div
        ...
        data-radix-collection-item=""
      >
        <span class="absolute end-2 pointer-events-none"></span>إظهار عناوين URL الكاملة
      </div>
    </div>
    <div
      role="separator"
    ...
    <div role="group" data-slot="context-menu-group">
      <div role="group" data-slot="context-menu-radio-group">
        ...
        <div
          ...
          data-radix-collection-item=""
        >
          <span class="absolute end-2 pointer-events-none"></span>Colm Tuite
        </div>
      </div>
    </div>
  </div>
  ...
  >
    <div role="group" data-slot="context-menu-group">
      ...
      >
        ...
        >رجوع<span
          data-slot="context-menu-shortcut"
          class="text-muted-foreground group-focus/context-menu-item:text-accent-foreground ms-auto text-xs tracking-widest"
          >⌘[</span
        >
      </div>
      <div
