...
{% <demo name="pagination-demo" status="authored"> %}
...
{% <codegroup> %}
```text,name=pagination-demo.html
<nav
  role="navigation"
...
{% <demo name="pagination-simple" status="authored"> %}
...
{% <codegroup> %}
```text,name=pagination-simple.html
<nav
  role="navigation"
  aria-label="pagination"
  data-slot="pagination"
...
{% <demo name="pagination-icons-only" status="authored"> %}
...
{% <codegroup> %}
```text,name=pagination-icons-only.html
...
{% <demo name="pagination-rtl" status="authored"> %}
