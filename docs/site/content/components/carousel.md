...
{% <demo name="carousel-demo" status="authored"> %}
...
(() => {
  ...
  // tools/.embla-entry.mjs
  globalThis.EmblaCarousel = EmblaCarousel;
})();
...
{% <demo name="carousel-size" status="authored"> %}
...
{% <demo name="carousel-spacing" status="authored"> %}
...
{% <codegroup> %}
```text,name=carousel-spacing.html
<div
  class="relative w-full max-w-[12rem] sm:max-w-xs md:max-w-sm"
  role="region"
  aria-roledescription="carousel"
...
{% <demo name="carousel-orientation" status="authored"> %}
...
{% <codegroup> %}
```text,name=carousel-orientation.html
<div
...
{% <demo name="carousel-api" status="authored"> %}
...
{% <demo name="carousel-plugin" status="authored"> %}
...
{% <codegroup> %}
```text,name=carousel-plugin.html
<div
...
{% <demo name="carousel-rtl" status="authored"> %}
