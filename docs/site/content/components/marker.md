...
{% <demo name="marker-demo" status="authored"> %}
...
{% <demo name="marker-variants" status="authored"> %}
...
{% <codegroup> %}
```text,name=marker-variants.html
<div class="flex w-full max-w-sm flex-col gap-8 py-12">
  <div
    data-slot="marker"
    data-variant="default"
...
{% <demo name="marker-status" status="authored"> %}
...
{% <demo name="marker-shimmer" status="authored"> %}
...
{% <demo name="marker-separator" status="authored"> %}
...
{% <codegroup> %}
```text,name=marker-separator.html
<div class="flex w-full max-w-sm flex-col gap-8 py-12">
  <div
    data-slot="marker"
    data-variant="separator"
...
{% <demo name="marker-border" status="authored"> %}
...
{% <demo name="marker-icon" status="authored"> %}
...
{% <demo name="marker-link-button" status="authored"> %}
...
{% <codegroup> %}
```text,name=marker-link-button.html
<div class="flex w-full max-w-sm flex-col gap-8 py-12">
  <a
