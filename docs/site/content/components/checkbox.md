...
{% <demo name="checkbox-demo" status="authored"> %}
...
{% <demo name="checkbox-invalid" status="authored"> %}
...
{% <codegroup> %}
```text,name=checkbox-invalid.html
<div
  data-slot="field-group"
...
{% <demo name="checkbox-basic" status="authored"> %}
...
{% <demo name="checkbox-description" status="authored"> %}
...
{% <codegroup> %}
```text,name=checkbox-description.html
<div
  data-slot="field-group"
...
{% <demo name="checkbox-disabled" status="authored"> %}
...
{% <codegroup> %}
```text,name=checkbox-disabled.html
<div
  data-slot="field-group"
  class="gap-5 data-[slot=checkbox-group]:gap-3 *:data-[slot=field-group]:gap-4 group/field-group @container/field-group flex flex-col mx-auto w-56"
>
...
{% <demo name="checkbox-group" status="authored"> %}
...
{% <demo name="checkbox-table" status="authored"> %}
...
{% <demo name="checkbox-rtl" status="authored"> %}
