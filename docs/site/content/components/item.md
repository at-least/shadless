...
{% <demo name="item-demo" status="authored"> %}
...
{% <demo name="item-variant" status="authored"> %}
...
{% <demo name="item-size" status="authored"> %}
...
{% <demo name="item-icon" status="authored"> %}
...
{% <demo name="item-avatar" status="authored"> %}
...
{% <demo name="item-image" status="authored"> %}
...
{% <demo name="item-group" status="authored"> %}
...
{% <demo name="item-header" status="authored"> %}
...
{% <demo name="item-link" status="authored"> %}
...
{% <demo name="item-dropdown" status="authored"> %}
...
{% <demo name="item-rtl" status="authored"> %}
