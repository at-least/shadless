...
{% <demo name="tabs-demo" status="existing-dist"> %}
...
{% <demo name="tabs-line" status="authored"> %}
...
{% <demo name="tabs-vertical" status="authored"> %}
...
{% <demo name="tabs-disabled" status="authored"> %}
...
{% <demo name="tabs-icons" status="authored"> %}
...
{% <demo name="tabs-rtl" status="authored"> %}
