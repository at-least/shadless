...
{% <demo name="accordion-demo" status="authored"> %}
...
{% <demo name="accordion-basic" status="authored"> %}
...
{% <codegroup> %}
```text,name=accordion-basic.html
<div data-slot="accordion" class="flex w-full flex-col max-w-lg" data-orientation="vertical">
  <div
    data-state="open"
    data-orientation="vertical"
...
{% <demo name="accordion-multiple" status="authored"> %}
...
{% <codegroup> %}
```text,name=accordion-multiple.html
<div
  data-slot="accordion"
  data-type="multiple"
...
{% <demo name="accordion-disabled" status="authored"> %}
...
{% <codegroup> %}
```text,name=accordion-disabled.html
...
{% <demo name="accordion-borders" status="authored"> %}
...
{% <codegroup> %}
```text,name=accordion-borders.html
<div
  data-slot="accordion"
...
{% <demo name="accordion-card" status="authored"> %}
...
{% <demo name="accordion-rtl" status="authored"> %}
