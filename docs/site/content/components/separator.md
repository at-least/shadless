...
{% <demo name="separator-demo" status="authored"> %}
...
{% <demo name="separator-vertical" status="authored"> %}
...
{% <codegroup> %}
```text,name=separator-vertical.html
...
{% <demo name="separator-menu" status="authored"> %}
...
{% <demo name="separator-list" status="authored"> %}
...
{% <demo name="separator-rtl" status="authored"> %}
