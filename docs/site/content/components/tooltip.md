...
{% <demo name="tooltip-demo" status="existing-dist"> %}
...
{% <demo name="tooltip-sides" status="authored"> %}
...
{% <demo name="tooltip-keyboard" status="authored"> %}
...
{% <codegroup> %}
```text,name=tooltip-keyboard.html
<button
  data-slot="tooltip-trigger"
  data-variant="outline"
  data-size="icon-sm"
...
{% <demo name="tooltip-disabled" status="authored"> %}
...
{% <codegroup> %}
```text,name=tooltip-disabled.html
...
{% <demo name="tooltip-rtl" status="authored"> %}
