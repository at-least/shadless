...
{% <demo name="aspect-ratio-demo" status="authored"> %}
...
{% <codegroup> %}
```text,name=aspect-ratio-demo.html
...
{% <demo name="aspect-ratio-square" status="authored"> %}
...
{% <codegroup> %}
```text,name=aspect-ratio-square.html
...
{% <demo name="aspect-ratio-portrait" status="authored"> %}
...
{% <codegroup> %}
```text,name=aspect-ratio-portrait.html
...
{% <demo name="aspect-ratio-rtl" status="authored"> %}
...
{% <codegroup> %}
```text,name=aspect-ratio-rtl.html
