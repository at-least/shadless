...
{% <demo name="menubar-demo" status="authored"> %}
...
{% <demo name="menubar-checkbox" status="authored"> %}
...
{% <codegroup> %}
```text,name=menubar-checkbox.html
<div
  role="menubar"
  data-slot="menubar"
  class="h-8 gap-0.5 rounded-lg border p-[3px] flex items-center w-72"
...
{% <demo name="menubar-radio" status="authored"> %}
...
{% <demo name="menubar-submenu" status="authored"> %}
...
{% <codegroup> %}
```text,name=menubar-submenu.html
<div
  role="menubar"
  data-slot="menubar"
  class="h-8 gap-0.5 rounded-lg border p-[3px] flex items-center w-72"
...
{% <demo name="menubar-icons" status="authored"> %}
...
{% <demo name="menubar-rtl" status="authored"> %}
