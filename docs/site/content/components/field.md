...
{% <demo name="field-demo" status="authored"> %}
...
{% <demo name="field-input" status="authored"> %}
...
{% <demo name="field-textarea" status="authored"> %}
...
{% <demo name="field-select" status="authored"> %}
...
{% <demo name="field-slider" status="authored"> %}
...
{% <demo name="field-fieldset" status="authored"> %}
...
{% <demo name="field-checkbox" status="authored"> %}
...
{% <demo name="field-radio" status="authored"> %}
...
{% <demo name="field-switch" status="authored"> %}
...
{% <demo name="field-choice-card" status="authored"> %}
...
{% <codegroup> %}
```text,name=field-choice-card.html
<div
  data-slot="field-group"
  class="gap-5 data-[slot=checkbox-group]:gap-3 *:data-[slot=field-group]:gap-4 group/field-group @container/field-group flex flex-col w-full max-w-xs"
>
...
{% <demo name="field-group" status="authored"> %}
...
{% <demo name="field-rtl" status="authored"> %}
...
{% <demo name="field-responsive" status="authored"> %}
...
{% <codegroup> %}
```text,name=field-responsive.html
