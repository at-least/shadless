...
{% <demo name="skeleton-demo" status="authored"> %}
...
{% <demo name="skeleton-avatar" status="authored"> %}
...
{% <codegroup> %}
```text,name=skeleton-avatar.html
...
{% <demo name="skeleton-card" status="authored"> %}
...
{% <demo name="skeleton-text" status="authored"> %}
...
{% <demo name="skeleton-form" status="authored"> %}
...
{% <demo name="skeleton-table" status="authored"> %}
...
{% <demo name="skeleton-rtl" status="authored"> %}
