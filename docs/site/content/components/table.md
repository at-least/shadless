...
{% <demo name="table-demo" status="authored"> %}
...
{% <demo name="table-footer" status="authored"> %}
...
{% <demo name="table-actions" status="authored"> %}
...
{% <demo name="table-rtl" status="authored"> %}
