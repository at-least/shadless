...
{% <demo name="dialog-demo" status="existing-dist"> %}
...
{% <demo name="dialog-close-button" status="authored"> %}
...
{% <codegroup> %}
```text,name=dialog-close-button.html
<button
  data-slot="dialog-trigger"
...
{% <demo name="dialog-no-close-button" status="authored"> %}
...
{% <codegroup> %}
```text,name=dialog-no-close-button.html
<button
  data-slot="dialog-trigger"
  data-variant="outline"
  data-size="default"
...
{% <demo name="dialog-sticky-footer" status="authored"> %}
...
{% <codegroup> %}
```text,name=dialog-sticky-footer.html
<button
  data-slot="dialog-trigger"
  data-variant="outline"
  data-size="default"
...
{% <demo name="dialog-scrollable-content" status="authored"> %}
...
{% <codegroup> %}
```text,name=dialog-scrollable-content.html
<button
  data-slot="dialog-trigger"
  data-variant="outline"
  data-size="default"
...
{% <demo name="dialog-rtl" status="authored"> %}
