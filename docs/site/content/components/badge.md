...
{% <demo name="badge-demo" status="authored"> %}
...
{% <demo name="badge-variants" status="authored"> %}
...
{% <demo name="badge-icon" status="authored"> %}
...
{% <demo name="badge-spinner" status="authored"> %}
...
{% <demo name="badge-link" status="authored"> %}
...
{% <demo name="badge-colors" status="authored"> %}
...
{% <demo name="badge-rtl" status="authored"> %}
