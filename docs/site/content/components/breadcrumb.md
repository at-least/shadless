...
{% <demo name="breadcrumb-demo" status="authored"> %}
...
{% <codegroup> %}
```text,name=breadcrumb-demo.html
...
{% <demo name="breadcrumb-basic" status="authored"> %}
...
{% <codegroup> %}
```text,name=breadcrumb-basic.html
<nav aria-label="breadcrumb" data-slot="breadcrumb" class="">
  <ol
    data-slot="breadcrumb-list"
    class="text-muted-foreground gap-1.5 text-sm flex flex-wrap items-center wrap-break-word"
...
{% <demo name="breadcrumb-separator" status="authored"> %}
...
{% <codegroup> %}
```text,name=breadcrumb-separator.html
<nav aria-label="breadcrumb" data-slot="breadcrumb" class="">
  <ol
    data-slot="breadcrumb-list"
    class="text-muted-foreground gap-1.5 text-sm flex flex-wrap items-center wrap-break-word"
...
{% <demo name="breadcrumb-dropdown" status="authored"> %}
...
{% <codegroup> %}
```text,name=breadcrumb-dropdown.html
<nav aria-label="breadcrumb" data-slot="breadcrumb" class="">
  <ol
    data-slot="breadcrumb-list"
    class="text-muted-foreground gap-1.5 text-sm flex flex-wrap items-center wrap-break-word"
...
{% <demo name="breadcrumb-ellipsis" status="authored"> %}
...
{% <codegroup> %}
```text,name=breadcrumb-ellipsis.html
<nav aria-label="breadcrumb" data-slot="breadcrumb" class="">
  <ol
    data-slot="breadcrumb-list"
    class="text-muted-foreground gap-1.5 text-sm flex flex-wrap items-center wrap-break-word"
...
{% <demo name="breadcrumb-link" status="authored"> %}
...
{% <codegroup> %}
```text,name=breadcrumb-link.html
<nav aria-label="breadcrumb" data-slot="breadcrumb" class="">
  <ol
    data-slot="breadcrumb-list"
    class="text-muted-foreground gap-1.5 text-sm flex flex-wrap items-center wrap-break-word"
...
{% <demo name="breadcrumb-rtl" status="authored"> %}
