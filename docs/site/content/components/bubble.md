...
{% <demo name="bubble-demo" status="authored"> %}
...
{% <demo name="bubble-variants" status="authored"> %}
...
{% <codegroup> %}
```text,name=bubble-variants.html
...
{% <demo name="bubble-alignment" status="authored"> %}
...
{% <codegroup> %}
```text,name=bubble-alignment.html
<div class="flex w-full max-w-sm flex-col gap-8 py-12">
  <div
    data-slot="bubble"
    data-variant="muted"
...
{% <demo name="bubble-group-demo" status="authored"> %}
...
{% <codegroup> %}
```text,name=bubble-group-demo.html
<div class="flex w-full max-w-sm flex-col gap-8 py-12">
  <div
    data-slot="bubble"
    data-variant="muted"
...
{% <demo name="bubble-link-button" status="authored"> %}
...
{% <codegroup> %}
```text,name=bubble-link-button.html
<div class="flex w-full max-w-sm flex-col gap-8 py-12">
  <div
    data-slot="bubble"
    data-variant="muted"
...
{% <demo name="bubble-reactions" status="authored"> %}
...
{% <codegroup> %}
```text,name=bubble-reactions.html
<div class="flex w-full max-w-sm flex-col gap-12 py-12">
  <div
    data-slot="bubble"
    data-variant="muted"
...
{% <demo name="bubble-collapsible" status="authored"> %}
...
{% <codegroup> %}
```text,name=bubble-collapsible.html
<div class="flex w-full max-w-sm flex-col gap-8 py-12">
  <div
    data-slot="bubble"
    data-variant="muted"
...
{% <demo name="bubble-tooltip" status="authored"> %}
...
{% <demo name="bubble-popover" status="authored"> %}
