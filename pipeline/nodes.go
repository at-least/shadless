...
var Nodes = []Node{
	...
	},
	{
		...
		Inputs:    []string{"tools/unit-check.mjs", "tools/unit/**", "src/**", "tools/**/*.mjs", "vendor/**", "package.json", "dist/esm/**", "dist/shadless.js", "probes/h4/globals.css", "pipeline/*_test.go", "pipeline/gate_css_direction.go", "pipeline/product_css.go"},
		Produces:  nil,
