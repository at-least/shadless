...
var Nodes = []Node{
	...
	},
	{
		...
		Inputs:    []string{"pipeline/interactivity_sweep.go", "pipeline/browser_shell.go", "tools/browser-shell.mjs", "docs/public/demos/**", "src/registry/tiers.json", "gates/ledger.json"},
		Produces:  nil,
